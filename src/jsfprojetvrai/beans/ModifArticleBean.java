...
@ManagedBean(name="modifArticleBean")
@SessionScoped



public class ModifArticleBean {
	 ...
	 Connection connection;
	   ...
	   // String rs;
		...
		//	        String dbadresse,String dbcodepostal,String dbville,String dbtelfixe,String dbmobile,String dbemail,String dbremarque) 
		  ...
		  public String modifArticleFinal  ()  // il ne faut pas lui donner des paramètres sinon problème
		  {
			...
			//  dbData(password);
		    	 ...
		    	 try {   
			    	  ...
			    	  connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/indigopro","root","jsfp");
			    	  statement = connection.createStatement();
 SQL = "UPDATE indigopro.clients SET code='"+dbcode+"',code_categorie='"+codecategorie+"',designation='"+dbdesignation+"',quantite="+dbquantite+",prix_unitaire='"+dbprixunitaire+"',date='"+dbdate+"' WHERE code LIKE ('"+code+"')";
